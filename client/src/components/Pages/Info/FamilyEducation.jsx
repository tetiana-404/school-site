...
const FamilyEducationEditor = ({ user }) => {
    ...
    const fetchFamilyEducation = async () => {
        try {
            const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/family-education`);
    ...
    const handleSubmit = async (e) => {
        ...
        const endpoint = editing
            ? `${process.env.REACT_APP_BACKEND_URL}/family-education/${editing.id}`
            : `${process.env.REACT_APP_BACKEND_URL}/family-education`;
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Видалити документ?')) {
            try {
                await fetch(`${process.env.REACT_APP_BACKEND_URL}/family-education/${id}`, {
                    method: 'DELETE',
                });
                await fetchFamilyEducation();
            } catch (error) {
