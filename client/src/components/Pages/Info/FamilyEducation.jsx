...
const FamilyEducationEditor = ({ user }) => {
    ...
    const fetchFamilyEducation = async () => {
        try {
            const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/family-education`);
    ...
    const handleSubmit = async (e) => {
        ...
        const endpoint = editing
            ? `${process.env.REACT_APP_BACKEND_URL}/api/family-education/${editing.id}`
            : `${process.env.REACT_APP_BACKEND_URL}/api/family-education`;
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Видалити документ?')) {
            try {
                await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/family-education/${id}`, {
                    method: 'DELETE',
                });
                await fetchFamilyEducation();
            } catch (error) {
    ...
    return (
        <section id="familyEducationPage" className="section-padding bg-light py-5">
            <div className="auto-container">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="welcome-section-title">
                            <h6 className="theme-color">Львівська гімназія "Євшан"</h6>
                            <h2>Сімейна (домашня) форма здобуття освіти</h2>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="py-3">
                            <img src={process.env.PUBLIC_URL + '/img/home-school.jpg'} className='w-100' />
...
export default FamilyEducationEditor;
