...
const CertificationsEditor = ({ user }) => {
  ...
  return (
    <section id="certificationsPage" className="bg-light">
      <div
        className="section-padding section-back-image-2 overlay"
        style={{ backgroundImage: `url(${process.env.PUBLIC_URL + '/img/bg/education.jpg'})` }}
      >
            ...
            <div className="col-lg-12 my-auto">
              <div className="text-center">
                <h2
                  ...
                  Підвищення кваліфікації педагогічних працівників</h2>
                <div
