...
const SchoolTimetable = ({ user }) => {
    ...
    const fetchSchedule = async () => {
        try {
            ...
            console.error('Не вдалося отримати розклад:', error);
        }
    };
    ...
    return (
        <section id="lessonsSchedulePage" className="section-padding bg-light py-5">
            <div className="auto-container">
                ...
                <div className="row">
                    <div className="col-lg-12">
                        ...
                        {editMode ? (
                            <>
                                <h3>{editing ? 'Редагування розкладу' : 'Додати розклад'}</h3>
